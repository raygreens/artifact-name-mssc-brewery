...
* The original package name 'rayguru.springframework.artifact-name-mssc-brewery' is invalid and this project uses 'rayguru.springframework.artifactnamemsscbrewery' instead.
